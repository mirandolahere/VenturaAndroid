...
class FertilizanteAdapter(internal var listener: FitosanitarioItemListener, personalLista: ArrayList<PEPDato>
                    ) : RecyclerView.Adapter<FertilizanteAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: FertilizanteAdapter.ViewHolder, i: Int) {
        val name = options[i]
