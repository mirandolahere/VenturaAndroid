...
class MaquinariaAdapter(internal var listener: FitosanitarioItemListener, personalLista: ArrayList<PEPDato>
    ...
    override fun onBindViewHolder(viewHolder: MaquinariaAdapter.ViewHolder, i: Int) {
        val name = options[i]
