...
class popupPersonalActivity   : AppCompatActivity(), PopupPersonalItemListener {
    ...
    fun setUpObservers(){
        ...
        laborViewModels.messageUpdateResult.observe(this, Observer {
            it?.let {
                ...
                startActivityForResult(Intent(this@popupPersonalActivity, AlertActivity::class.java), REQUEST_ACTIVITY)
