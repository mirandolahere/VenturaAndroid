package com.application.venturaapp.maquinarias.adapter
...
class MaquinariasPEPAdapter(internal var listener: VSAGRRMAQItemListener, laborLista: ArrayList<VSAGRRMAQ>
                    ) : RecyclerView.Adapter<MaquinariasPEPAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: MaquinariasPEPAdapter.ViewHolder, i: Int) {
        val name = options[i]
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        @RequiresApi(Build.VERSION_CODES.O)
        fun bindItem(name: VSAGRRMAQ, position: Int) {
