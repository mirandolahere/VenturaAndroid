...
class maquinariasViewModel (application: Application) : AndroidViewModel(application)  {

    val maquinariasDataModel: maquinariasDataModel =  maquinariasDataModel()
    val VSAGRRMAQ: MutableLiveData<List<VSAGRRMAQ>> = MutableLiveData()
    ...
    private fun setupObservers() {
        ...
        maquinariasDataModel.messageLiveData.observeForever {
            it?.let {
                onRetrieveLoginUserFinish()
                messageUpdateResult.value = it
            }
        }
        maquinariasDataModel.responseMaquinariasLiveData.observeForever {
            it?.let {
                VSAGRRMAQ.value = it
    ...
    fun listaMaquinarias(
        ...
        onRetrieveLoginUser()
        listaMaquinariasTask(this, sessionid,codigoPEP,httpCacheDirectory,context).execute()
    }


////////////////////////// TASK
    private class listaMaquinariasTask internal constructor(
    private var viewModel: maquinariasViewModel,
    ...
    private var context: Context
        ...
        override fun onPostExecute(aBoolean: Boolean?) {
            ...
            // if (aBoolean == true)
            viewModel.maquinariasDataModel.listMaquinarias(sessionid,codigoPEP,httpCacheDirectory, context)
            /*else
