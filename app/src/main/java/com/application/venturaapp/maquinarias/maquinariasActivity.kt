...
import com.application.venturaapp.maquinarias.adapter.MaquinariasPEPAdapter
import com.application.venturaapp.maquinarias.listener.VSAGRRMAQItemListener
...
class maquinariasActivity   : AppCompatActivity(), VSAGRRMAQItemListener {
    ...
    lateinit var maquinariasViewModels: maquinariasViewModel
    lateinit var laborViewModels: laborCulturaViewModel

    var laborList  = arrayListOf<VSAGRRMAQ>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        maquinariasViewModels = ViewModelProviders.of(this).get(maquinariasViewModel::class.java)
    ...
    {
        val filter: ArrayList<VSAGRRMAQ> = ArrayList()
        ...
        rvLaborCultural.adapter = (MaquinariasPEPAdapter(this,filter))
    ...
    fun setUpObservers(){
        ...
        maquinariasViewModels.VSAGRRMAQ.observe(this, Observer {
            it?.let { it1 ->
                ...
                */
                laborList = it1 as ArrayList<VSAGRRMAQ>
                ...
                rvLaborCultural.adapter = (MaquinariasPEPAdapter(this, laborList))
                rvLaborCultural.layoutManager = LinearLayoutManager(this)
        ...
        maquinariasViewModels.pgbVisibility.observe(this, Observer {
            it?.let {
    ...
    private fun LaborListar() {
        pref.getString(Constants.B1SESSIONID)?.let { maquinariasViewModels.listaMaquinarias(it, CodigoPEP,httpCacheDirectory, this) }
    }
    ...
    override fun laborItemClickListener(position: VSAGRRMAQ?) {
